    ...
    public static class EnvelopeTransformer implements Transformer {
        ...
        public Builder<?> transform(
            ...
            return builder
                    ...
                    .visit(Advice.to(EnvelopeConstructorAdvice.class).on(ElementMatchers.isConstructor()))
                    // Track when envelope is copied
                    .visit(Advice.to(EnvelopeCopyAdvice.class).on(ElementMatchers.named("copy")));
        }
    }
    ...
    public static class DispatchTransformer implements Transformer {
        ...
        public Builder<?> transform(
            ...
            return builder
                    ...
                    .visit(Advice.to(SendMessageAdvice.class)
