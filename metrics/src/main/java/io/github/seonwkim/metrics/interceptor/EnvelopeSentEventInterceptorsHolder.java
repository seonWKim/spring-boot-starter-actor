...
/**
 * Registry for envelope sent event interceptors that monitors when message envelopes are dispatched
 * to target actors.
 *
 * <p>The envelope sent event represents the point where a message leaves its origin and enters the
 * delivery infrastructure. This is crucial for understanding message flow dynamics, detecting
 * communication bottlenecks, and ensuring reliable message delivery across the actor system.
 */
