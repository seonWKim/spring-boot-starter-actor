...
/**
 * Service that handles interactions with the HelloActor.
 * It serves as an intermediary between the REST API and the actor system.
 */
@Service
public class HelloService {
     ...
     * Initializes a single HelloActor instance that will be used for all requests.
     *
    ...
    public HelloService(SpringActorSystem springActorSystem) {
        ...
        this.helloActor = springActorSystem.spawn(
                HelloActor.Command.class, 
                "default", 
