...
/**
 * REST controller that exposes the counter functionality via HTTP endpoints.
 * Provides APIs for incrementing and getting counter values using different synchronization methods.
 */
@RestController
