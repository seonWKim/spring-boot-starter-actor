 ...
 */
@Service
public class DbCounterServiceImpl implements DbCounterService {

    private static final Logger logger = LoggerFactory.getLogger(DbCounterServiceImpl.class);
     ...
     */
    public DbCounterServiceImpl(CounterRepository counterRepository) {
