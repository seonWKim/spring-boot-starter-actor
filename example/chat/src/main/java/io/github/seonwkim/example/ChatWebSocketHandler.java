 ...
 * Handles WebSocket connections and messages, and connects them to the actor system.
 */
@Component
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    public ChatWebSocketHandler(ObjectMapper objectMapper, ChatService chatService, SpringActorSystem actorSystem) {
