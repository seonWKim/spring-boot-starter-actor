 ...
 * Each entity is a separate instance identified by an entity ID.
 * The actor responds with information about the node it's running on.
 */
@Component
public class HelloActor implements ShardedActor<HelloActor.Command> {
    ...
    /**
     * Provides a message extractor for sharding.
     * This determines how messages are routed to the correct entity.
     *
