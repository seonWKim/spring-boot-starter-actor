...
public class OrderProcessorActor implements SpringActor<OrderProcessorActor.Command> {
    ...
    public static class ProcessOrder extends AskCommand<OrderProcessed> implements Command {
        public final String orderId;
        public final String userId;
        public final double amount;
        public final String requestId;

        public ProcessOrder(String orderId, String userId, double amount, String requestId) {
        ...
        return SpringActorBehavior.builder(Command.class, actorContext)
                ...
                .onMessage(ProcessOrder.class, (ctx, msg) -> {
                    ...
                    try {
                        ...
                        msg.reply(new OrderProcessed(msg.orderId, "SUCCESS", "Order processed successfully"));

                    } catch (Exception e) {
                        ctx.getLog().error("Failed to process order", e);
                        msg.reply(
                                new OrderProcessed(msg.orderId, "ERROR", "Failed to process order: " + e.getMessage()));
                    }
