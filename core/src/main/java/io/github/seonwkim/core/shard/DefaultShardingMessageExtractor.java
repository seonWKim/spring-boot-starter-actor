...
/**
 * Default implementation of ShardingMessageExtractor for extracting entity IDs and shard IDs from messages.
 * This class is used to determine how messages are routed to shards and entities within a cluster.
 * It extracts entity IDs from ShardEnvelope objects and calculates shard IDs based on a hash of the entity ID.
 *
...
public class DefaultShardingMessageExtractor<T> extends ShardingMessageExtractor<ShardEnvelope<T>, T> {
    ...
    /**
     * Calculates the shard ID for a given entity ID.
     * This method uses a hash of the entity ID modulo the number of shards to distribute entities evenly.
     *
