...
/**
 * Registry for sharded actors.
 * This class maintains a mapping between entity type keys and their corresponding sharded actors.
 * It provides methods for registering, retrieving, and listing sharded actors.
 */
public class ShardedActorRegistry {
     ...
     * This instance can be used when a shared registry is needed.
     */
    public static ShardedActorRegistry INSTANCE = new ShardedActorRegistry();

    /**
     * Registers a sharded actor with the registry.
     * The actor is indexed by its entity type key.
     *
