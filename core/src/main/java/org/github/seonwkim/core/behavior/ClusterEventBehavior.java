...
/**
 * A behavior for handling cluster events.
 * This class provides a behavior that listens for cluster events and publishes them as Spring application events.
 */
public class ClusterEventBehavior {

    /**
     * Creates a behavior that listens for cluster events and publishes them as Spring application events.
     *
    ...
    /**
     * A Spring application event that wraps a Pekko cluster domain event.
     * This class allows Pekko cluster events to be published and consumed using Spring's event system.
     */
