...
/**
 * A wrapper class that associates a message with an entity ID.
 * This class is used to route messages to the correct entity in a sharded actor system.
 * It contains both the entity ID and the message payload.
 *
