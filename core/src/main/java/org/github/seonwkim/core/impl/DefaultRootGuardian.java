...
/**
 * Default implementation of the RootGuardian interface.
 * This class manages the lifecycle of actors and maintains references to them.
 * It handles commands for spawning actors and returns references to them.
 */
public class DefaultRootGuardian implements RootGuardian {

    /**
     * Command to spawn a new actor.
     * This command is sent to the root guardian to create a new actor of the specified type with the given ID.
     *
    ...
    /**
     * Response message containing a reference to a spawned actor.
     * This message is sent in response to a SpawnActor command.
     *
     * @param <T> The type of messages that the actor can handle
     */
    ...
    /**
     * Creates the behavior for this DefaultRootGuardian.
     * The behavior handles SpawnActor commands by creating or retrieving actor references.
     *
    ...
    /**
     * Handles a SpawnActor command by creating or retrieving an actor reference.
     * If an actor with the given command class and ID already exists, its reference is returned.
     * Otherwise, a new actor is created and its reference is returned.
     *
